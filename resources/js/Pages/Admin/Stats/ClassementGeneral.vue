        ...
        <div class="min-h-screen bg-gradient-to-br from-slate-50 via-slate-100 to-white text-gray-900 font-sans relative">
            ...
            <div class="relative bg-gradient-to-b from-white to-slate-50 py-12 px-4 border-b border-gray-200">
                ...
                <div class="text-center mb-8">
                    ...
                    <div class="text-gray-600 text-lg font-medium tracking-wide">Points = Buts + Passes/2</div>
                </div>
            </div>
            ...
            <div class="max-w-5xl mx-auto px-4 py-12 relative z-10">
                ...
                <div v-if="props.classement.length === 0" class="text-center py-32">
                    <div class="mb-8">
                        <i class="fas fa-medal text-lime-200 text-7xl mb-8"></i>
                    </div>
                    <p class="text-3xl font-bold text-gray-600 mb-4">AUCUNE DONNÉE</p>
                    <p class="text-gray-500 font-medium">Aucun combattant n'a encore marqué de points</p>
                </div>

                <!-- Podium pour le top 3 -->
                <div v-if="props.classement.length >= 3" class="mb-16">
                    <div class="flex justify-center items-end gap-8 mb-8">
                        ...
                        <div class="flex flex-col items-center">
                            ...
                            <p class="text-gray-900 font-bold text-lg">{{ props.classement[1].name }}</p>
                            <p class="text-gray-600 text-sm font-medium">{{ props.classement[1].pseudo }}</p>
                            <div class="mt-2">
                                <p class="text-gray-600 text-sm font-medium">{{ props.classement[1].points }} pts</p>
                            </div>
                        </div>
                        ...
                        <div class="flex flex-col items-center">
                            ...
                            <p class="text-gray-900 font-bold text-xl">{{ props.classement[0].name }}</p>
                            <p class="text-gray-600 text-sm font-medium">{{ props.classement[0].pseudo }}</p>
                            <div class="mt-2">
                                <p class="text-lime-600 text-sm font-bold">{{ props.classement[0].points }} pts</p>
                                <p class="text-gray-600 text-xs">B: {{ props.classement[0].total_goals }} | P: {{ props.classement[0].total_assists }}</p>
                            </div>
                        </div>
                        ...
                        <div class="flex flex-col items-center">
                            ...
                            <p class="text-gray-900 font-bold text-lg">{{ props.classement[2].name }}</p>
                            <p class="text-gray-600 text-sm font-medium">{{ props.classement[2].pseudo }}</p>
                            <div class="mt-2">
                                <p class="text-amber-600 text-sm font-medium">{{ props.classement[2].points }} pts</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <!-- Tableau complet -->
                <div v-if="props.classement.length > 0" class="bg-white backdrop-blur-sm rounded-2xl overflow-hidden border-2 border-lime-200/50 shadow-xl">
                    ...
                    <div class="bg-gradient-to-r from-lime-50 to-emerald-50 px-8 py-6 border-b border-lime-200">
                        <div class="grid grid-cols-12 gap-6 text-gray-700 text-sm font-semibold tracking-wide">
                            ...
                            <div class="col-span-5">COMBATTANT</div>
                        ...
                        <div v-for="(joueur, index) in props.classement" 
                            ...
                            <div class="grid grid-cols-12 gap-6 items-center">
                                ...
                                <div class="col-span-5 flex items-center gap-4">
                                    ...
                                    <div>
                                        <p class="font-bold text-gray-900 uppercase tracking-wide text-lg">{{ joueur.name }}</p>
                                        <p class="text-gray-600 text-sm font-medium">{{ joueur.pseudo }}</p>
                                    </div>
                                </div>
                                ...
                                <div class="col-span-2 text-center">
                                    <div class="bg-lime-50 rounded-xl px-4 py-3 border border-lime-200">
                                        <span class="text-gray-900 font-bold text-2xl">{{ joueur.points }}</span>
                                    </div>
                                </div>
                ...
                <div v-if="props.classement.length > 0" class="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
                    <div class="bg-gradient-to-br from-white to-lime-50 backdrop-blur-sm rounded-2xl p-8 text-center border-2 border-lime-200/50 shadow-lg">
                        ...
                        <p class="text-4xl font-bold text-lime-600">{{ props.classement[0]?.points || 0 }}</p>
                        <p class="text-gray-600 text-sm tracking-wide font-semibold mt-2">POINTS DU LEADER</p>
                        <p class="text-gray-900 mt-2 font-bold">{{ props.classement[0]?.name || '-' }}</p>
                    </div>
                    ...
                    <div class="bg-gradient-to-br from-white to-lime-50 backdrop-blur-sm rounded-2xl p-8 text-center border-2 border-lime-200/50 shadow-lg">
                        ...
                        <p class="text-gray-600 text-sm tracking-wide font-semibold mt-2">TOTAL POINTS CLUB</p>
                    </div>
                    ...
                    <div class="bg-gradient-to-br from-white to-lime-50 backdrop-blur-sm rounded-2xl p-8 text-center border-2 border-lime-200/50 shadow-lg">
                        ...
                        <p class="text-4xl font-bold text-gray-900">{{ props.classement.length }}</p>
                        <p class="text-gray-600 text-sm tracking-wide font-semibold mt-2">COMBATTANTS CLASSÉS</p>
                    </div>
                </div>
