        ...
        <div class="mb-6 rounded-lg bg-white p-4 shadow-sm sm:p-6">
          ...
          <div class="mb-4">
            ...
            <div class="flex gap-2">
              <input v-model="searchQuery" type="text" placeholder="Nom ou email..."
            ...
            <div class="overflow-x-auto">
              <table class="w-full">
                ...
                <thead class="bg-gray-50 border-b border-gray-200">
                  <tr>
                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-700 uppercase tracking-wider">Pseudo
                    </th>
                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-700 uppercase tracking-wider">Email
                    </th>
                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-700 uppercase tracking-wider">Position
                    </th>
                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-700 uppercase tracking-wider">Role</th>
                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-700 uppercase tracking-wider">Statut
                    </th>
    ...
    <div v-if="showDeleteModal" class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 p-4">
      <div class="w-full max-w-sm rounded-lg bg-white p-6 shadow-lg">
        ...
        <p class="mb-6 text-sm text-gray-600">
          Etes-vous sur de vouloir supprimer le membre <span class="font-medium">{{ selectedMember?.pseudo }}</span> ?
          Cette
