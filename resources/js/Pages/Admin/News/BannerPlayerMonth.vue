...
<template>
    ...
    <section class="p-6 bg-white dark:bg-gray-800 rounded-xl shadow-md flex flex-col lg:flex-row gap-6 transition-colors">
        ...
        <div class="flex-1 flex flex-col gap-6">
            ...
            <div class="grid grid-cols-2 gap-4">
                <div class="flex flex-col p-4 rounded bg-gray-100 dark:bg-gray-700">
                    <p class="text-gray-700 dark:text-gray-300">Buts</p>
                    <p class="text-2xl font-bold text-gray-900 dark:text-gray-100">{{ stats?.goals ?? 0 }}</p>
                </div>

                <div class="flex flex-col p-4 rounded bg-gray-100 dark:bg-gray-700">
                    <p class="text-gray-700 dark:text-gray-300">Passes Décisives</p>
                    <p class="text-2xl font-bold text-gray-900 dark:text-gray-100">{{ stats?.assists ?? 0 }}</p>
                </div>

                <div class="flex flex-col p-4 rounded bg-gray-100 dark:bg-gray-700">
                    <p class="text-gray-700 dark:text-gray-300">Matchs Joués</p>
                    <p class="text-2xl font-bold text-gray-900 dark:text-gray-100">{{ stats?.matches_played ?? 0 }}</p>
                </div>

                <div class="flex flex-col p-4 rounded bg-gray-100 dark:bg-gray-700">
                    <p class="text-gray-700 dark:text-gray-300">Buts encaissés</p>
                    <p class="text-2xl font-bold text-gray-900 dark:text-gray-100">{{ stats?.goals_against ?? 0 }}</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="mt-10">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            <div
                ...
                :key="p.id"
                class="p-4 bg-white dark:bg-gray-800 rounded-xl shadow-md flex flex-col gap-3 transition-colors"
            >
