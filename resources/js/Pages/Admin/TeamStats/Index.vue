        ...
        <div class="max-w-7xl mx-auto p-4">
            ...
            >
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-sm opacity-90 mt-1">
                            Gestion mensuelle des résultats — victoires,
                            défaites, nuls
                        </p>
                    </div>
                </div>
                <div class="flex-shrink-0 flex items-center justify-end">
                    <Link
                        :href="route('admin.team-stats.create')"
                        class="inline-flex items-center gap-3 px-4 py-2.5 text-sm font-semibold text-sky-900 bg-white rounded-lg shadow hover:scale-[1.02] transition"
                    >
                        <svg
            ...
            <ConfirmModal
                ...
                message="Êtes-vous sûr de vouloir supprimer cette stat ? Cette action est irréversible."
            ...
            >
                        ...
                        <tbody>
                            ...
                            >
                                ...
                                <td class="px-6 py-4">
                                    ...
                                    >
                                        <span
                                            class="px-2 py-1 bg-green-50 text-green-700 rounded"
                                            >✓ {{ stat.wins }}</span
                                        >
                                        <span
                                            class="px-2 py-1 bg-red-50 text-red-700 rounded"
                                            >✗ {{ stat.losses }}</span
                                        >
                                        <span
                                            class="px-2 py-1 bg-yellow-50 text-yellow-700 rounded"
                                            >= {{ stat.draws }}</span
                                        >
                                    </div>
                                </td>
                                ...
                                <td
                                    class="px-6 py-4 text-center font-semibold text-sky-700"
                                >
                                    {{ stat.wins * 3 + stat.draws }}
                                </td>
                                <td class="px-6 py-4 text-center">
                                    <div
                                        class="inline-block px-3 py-1 bg-sky-50 text-sky-700 rounded-full text-sm font-semibold"
                                    >
                                        {{
                                            (
                                                (stat.wins /
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex justify-center gap-2">
                                        <Link
                                            :href="
                                                route(
                                                    'admin.team-stats.edit',
                                                    stat.id
                                                )
                                            "
                                            class="text-sky-900 font-medium"
                                            >Éditer</Link
                                        >
                                        <button
                ...
                >
                    ...
                    >
                        ...
                        <div class="grid grid-cols-3 gap-2 mb-3">
                            <div
                                class="text-center p-2 bg-green-100 dark:bg-green-900 rounded"
                            >
                                <p
                            ...
                            <div
                                class="text-center p-2 bg-red-100 dark:bg-red-900 rounded"
                            >
                                <p
                            ...
                            <div
                                class="text-center p-2 bg-yellow-100 dark:bg-yellow-900 rounded"
                            >
                                <p
                        ...
                        <div class="grid grid-cols-2 gap-2 mb-3">
                            <div
                                class="bg-blue-50 dark:bg-blue-900 p-2 rounded"
                            >
                                <p
                            ...
                            <div
                                class="bg-purple-50 dark:bg-purple-900 p-2 rounded"
                            >
                                <p
                        ...
                        >
                            <Link
                                :href="route('admin.team-stats.edit', stat.id)"
                                class="flex-1 text-center px-3 py-2 text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 rounded transition"
                            >
                                Éditer
                            </Link>
                            <button
                                @click="deleteStat(stat.id)"
                                class="flex-1 px-3 py-2 text-sm font-medium text-white bg-red-600 hover:bg-red-700 rounded transition"
                            >
                                Supprimer
                            </button>
                        </div>
                ...
                <div v-if="stats.data.length === 0" class="text-center py-12">
                    ...
                    <Link
                        :href="route('admin.team-stats.create')"
                        class="inline-block px-4 py-2 text-sm font-medium text-white bg-green-600 hover:bg-green-700 rounded-lg transition"
                    >
            ...
            >
                <p class="text-sm text-gray-600 dark:text-gray-400">
                    Affichage {{ stats.from }} à {{ stats.to }} sur
                    {{ stats.total }} stats
                </p>
