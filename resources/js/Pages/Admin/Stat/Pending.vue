...
<template>
    <div class="flex">
        ...
        <div
            class="relative min-h-screen w-full bg-background-light text-zinc-800 font-display"
        >
            <div
                class="px-4 sm:px-8 md:px-16 lg:px-24 xl:px-40 py-5 flex justify-center"
            >
                <div class="max-w-[960px] w-full">
                    ...
                    <div class="flex justify-between items-center p-4">
                        <div>
                            ...
                            <p class="text-zinc-600 mt-2">
                                {{ props.stats.length }} statistique(s) en
                    ...
                    <div class="space-y-4 p-4">
                        ...
                        >
                            <i
                                class="fas fa-check-circle text-green-500 text-6xl mb-4"
                            ></i>
                            <p class="text-xl font-semibold text-zinc-700">
                                Tout est à jour !
                            </p>
                            <p class="text-zinc-500 mt-2">
                                Aucune statistique en attente de validation
                            </p>
                        </div>
                        ...
                        >
                            ...
                            <div class="flex justify-between items-start mb-4">
                                <div class="flex items-center gap-4">
                                    <img
                                        :src="
                                            stat.user.avatar ||
                                            'https://via.placeholder.com/100x100.png/00ee99?text=J'
                                        "
                            ...
                            <div class="grid grid-cols-4 gap-4 mb-6">
                                ...
                                >
                                    <i
                                        class="fas fa-futbol text-green-500 text-2xl mb-2"
                                    ></i>
                                    <p
                                ...
                                >
                                    <i
                                        class="fas fa-hands-helping text-blue-500 text-2xl mb-2"
                                    ></i>
                                ...
                                >
                                    <i
                                        class="fas fa-shield-alt text-red-500 text-2xl mb-2"
                                    ></i>
                                ...
                                >
                                    <i
                                        class="fas fa-calendar text-purple-500 text-2xl mb-2"
                                    ></i>
                                    <p
