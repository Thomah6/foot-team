                    ...
                    <div class="flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
                        <div>
                            <h1 class="text-3xl md:text-4xl font-black mb-2 flex items-center gap-3">
                                <i class="fas fa-history text-lime-200"></i>
            ...
            <div class="container mx-auto px-4 py-8">
                ...
                <div v-if="props.players.data.length > 0" class="max-w-4xl mx-auto">
                    <div class="grid gap-6">
                        <div v-for="player in props.players.data" :key="player.id"
                             class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 hover:shadow-lg transition-shadow hover:border-lime-300 dark:hover:border-lime-500">
                            <div class="p-6">
                                <div class="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
                                    <div class="flex items-center gap-4">
                                        <!-- Date -->
                                        <div class="text-center">
                                            <div class="bg-lime-100 dark:bg-lime-900/50 text-lime-600 dark:text-lime-300 rounded-lg px-3 py-2 border border-lime-200 dark:border-lime-800">
                                        ...
                                        <!-- Photo et infos -->
                                        <div class="flex items-center gap-4">
                                            <img :src="player.user.avatar || 'https://ui-avatars.com/api/?name=' + encodeURIComponent(player.user.name) + '&background=lime-500&color=white'"
                                                 class="w-16 h-16 rounded-full object-cover border-2 border-lime-200 dark:border-lime-700" />
                                            <div>
                                    ...
                                    <div class="flex items-center gap-3">
                                        <Link :href="`/joueur-du-mois/${formatMonthUrl(player.month)}/stats`"
                                              class="px-4 py-2 bg-lime-600 hover:bg-lime-700 dark:bg-lime-500 dark:hover:bg-lime-600 text-white rounded-lg transition font-semibold flex items-center gap-2">
                                ...
                                <!-- Motivation -->
                                <div v-if="player.reason" class="mt-4 bg-lime-50 dark:bg-lime-900/20 rounded-lg p-4 border border-lime-200 dark:border-lime-800">
                        ...
                        <div class="flex justify-center gap-2 flex-wrap">
                            <template v-for="link in props.players.links" :key="link.label">
                                <Link v-if="link.url" 
                                      :href="link.url"
                                      :class="link.active 
                                        ? 'bg-lime-600 dark:bg-lime-500 text-white px-4 py-2 rounded-lg font-semibold' 
                ...
                <div v-else class="max-w-2xl mx-auto text-center py-16">
                    <div class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 p-8">
                        <div class="bg-lime-100 dark:bg-lime-900/30 w-24 h-24 rounded-full flex items-center justify-center mx-auto mb-6">
                            <i class="fas fa-history text-lime-600 dark:text-lime-400 text-4xl"></i>
                        </div>
                        ...
                        <Link href="/joueur-du-mois"
                              class="inline-flex items-center gap-2 bg-lime-600 hover:bg-lime-700 dark:bg-lime-500 dark:hover:bg-lime-600 text-white px-6 py-3 rounded-lg transition font-semibold">
