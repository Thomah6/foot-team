            ...
            <div class="relative bg-gradient-to-b from-white to-citron-50 dark:from-gray-900 dark:to-gray-800 py-8 sm:py-12 lg:py-16 px-4 border-b border-citron-200 dark:border-gray-700">
                <div class="flex flex-col sm:flex-row items-center justify-between max-w-6xl mx-auto mb-8 sm:mb-12 gap-6">
                    ...
                    <div class="flex items-center gap-3 sm:gap-4">
                        ...
                        <div class="text-citron-700 dark:text-citron-300 font-light text-lg sm:text-xl tracking-wider hidden sm:block">FOOT TEAM</div>
                    </div>
                    
                    <!-- Titre central -->
                    <div class="text-center order-first sm:order-none">
                        <div class="text-citron-600 dark:text-citron-400 text-lg sm:text-xl font-light tracking-widest mb-1 sm:mb-2">STATISTIQUES</div>
                ...
                <div class="text-center mb-8 sm:mb-12">
                    <h1 class="text-3xl sm:text-4xl lg:text-6xl font-thin text-gray-900 dark:text-citron-50 tracking-wider mb-3 sm:mb-4">TABLEAU DE BORD</h1>
                    <div class="text-citron-600 dark:text-citron-400 text-sm sm:text-lg tracking-widest font-light">Validation des statistiques</div>
                </div>
            </div>
