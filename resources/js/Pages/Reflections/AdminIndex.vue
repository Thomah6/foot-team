            ...
            <div class="max-w-full mx-auto py-10 px-4 sm:px-6 lg:px-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-8 auto-rows-min md:auto-rows-max">
                    ...
                    <div class="w-full mx-auto md:mx-0 flex flex-col">
                        <CreateForm/>
                        <h1 class="mt-6 text-lg sm:text-xl font-bold text-gray-900 dark:text-citron-50">Mes réflexions</h1>
                       <div v-for="reflection in reflections.filter(reflection => reflection.user_id === $page.props.auth.user?.id)" class="scroller mt-6 max-h-48 sm:max-h-72 md:max-h-96 overflow-y-auto" :key="reflection.id">
                            <UserReflection
...
>
    <div class="bg-white dark:bg-gray-800 rounded-lg p-4 sm:p-6 w-full max-w-sm sm:max-w-md shadow-xl border border-gray-200 dark:border-gray-700 max-h-[90vh] overflow-y-auto">
        ...
        <h2 class="text-lg sm:text-xl font-semibold mb-4 text-gray-900 dark:text-citron-50">Modifier la réflexion</h2>
