<template>
  <div class="bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-xl border border-citron-100 dark:border-citron-900 transform hover:shadow-2xl transition duration-300">
    <div class="flex justify-between">
        <h3 class="text-2xl font-extrabold text-lime-500 dark:text-citron-300 mb-5 border-b pb-3 border-citron-200 dark:border-lime-500">Partagez votre Inspi ⚽</h3>
    ...
    <form @submit.prevent="submit">
        ...
        <input type="text"
            name="titre"
            v-model="form.titre"
            class="cursor-custom-icon w-full my-6 p-4 border-2 border-gray-300 dark:border-gray-600 rounded-xl focus:ring-citron-500 focus:border-lime-500 transition duration-200 resize-none text-gray-700 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 font-medium bg-gray-50 dark:bg-gray-700"
      ...
      <button
        ...
        class="mt-6 w-full px-6 py-3 bg-lime-500 hover:bg-lime-500 dark:bg-citron-500 dark:hover:bg-lime-500 text-white text-lg font-bold rounded-xl transition duration-300 transform hover:scale-[1.01] disabled:opacity-50 disabled:cursor-not-allowed"
      >
